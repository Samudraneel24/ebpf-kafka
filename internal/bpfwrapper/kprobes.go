...
var (
	...
	defaultKprobes = []Kprobe{
		...
		{
			FunctionToHook: "sendmmsg",
			HookName:       "syscall__probe_entry_sendmmsg",
			Type:           EntryType,
			IsSyscall:      true,
		},
		{
			FunctionToHook: "sendmmsg",
			HookName:       "syscall__probe_ret_sendmmsg",
			Type:           ReturnType,
			IsSyscall:      true,
		},
		{
		...
		// },
		{
			FunctionToHook: "recvmmsg",
			HookName:       "syscall__probe_entry_recvmmsg",
			Type:           EntryType,
			IsSyscall:      true,
		},
		{
			FunctionToHook: "recvmmsg",
			HookName:       "syscall__probe_ret_recvmmsg",
			Type:           ReturnType,
			IsSyscall:      true,
		},
		{
